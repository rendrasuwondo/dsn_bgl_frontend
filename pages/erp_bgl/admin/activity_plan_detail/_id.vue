          ...
          <h3 class="card-title">
            <table>
              <tr>
                <td>
                  <nuxt-link
                    :to="{ name: 'erp_bgl-admin-activity_plan' }"
                    class="nav-link"
                  >
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <nuxt-link
                  :to="{
                    name: 'erp_bgl-admin-activity_plan_detail-create-id',
          ...
          >
            ...
            <template v-slot:cell(actions)="row">
              <b-button
                :to="{
                  name: 'erp_bgl-admin-activity_plan_detail-edit-id',
            ...
            <template v-slot:cell(detail)="row">
              <b-button
                :to="{
                  name: 'erp_bgl-admin-activity_plan_detail',
